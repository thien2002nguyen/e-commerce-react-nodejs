...
const Cart = ({ dispatch, navigate }) => {
    ...
    return (
        <div className='overflow-y-auto overflow-x-hidden flex justify-end h-full'>
            <div
                className='w-[375px] h-full bg-[#1c1d1d] text-white overflow-y-auto grid grid-rows-12 px-6'
            ...
            >
                ...
                <section className='row-span-8 py-4 flex flex-col gap-4 h-full overflow-y-auto border-b
                    border-gray-600'>
                        ...
                        <div key={index} className='flex justify-between items-center'>
                            ...
                            <div className='flex flex-col items-end gap-1'>
                                <div className='text-sm'>
                                    {`${formatMoney(element.price * (element.quantity || 1))} VNĐ`}
                                </div>
                                <div
